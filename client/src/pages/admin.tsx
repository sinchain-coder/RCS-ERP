    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === "store-master" && (
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2" data-testid="text-store-master-title">
                <Store className="w-5 h-5" />
                Store Master
              </CardTitle>
              <CardDescription data-testid="text-store-master-description">
                Manage store locations and configurations
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-muted-foreground" data-testid="text-store-master-placeholder">
                Store Master functionality coming soon...
              </div>
            </CardContent>
          </Card>
        )}
        ...
        {activeTab === "item-master" && (
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2" data-testid="text-item-master-title">
                <Package className="w-5 h-5" />
                Item Master
              </CardTitle>
              <CardDescription data-testid="text-item-master-description">
                Comprehensive item and product management
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-muted-foreground" data-testid="text-item-master-placeholder">
                Item Master functionality coming soon...
              </div>
            </CardContent>
          </Card>
        )}
        ...
        {activeTab === "dispatch-checklist" && (
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2" data-testid="text-dispatch-title">
                <Clipboard className="w-5 h-5" />
                Dispatch Checklist
              </CardTitle>
              <CardDescription data-testid="text-dispatch-description">
                Order dispatch and delivery management
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-muted-foreground" data-testid="text-dispatch-placeholder">
                Dispatch Checklist functionality coming soon...
              </div>
            </CardContent>
          </Card>
        )}
        ...
        {activeTab === "settings" && (
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8 text-muted-foreground" data-testid="text-settings-placeholder">
